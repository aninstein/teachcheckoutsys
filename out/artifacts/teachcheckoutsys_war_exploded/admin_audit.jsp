...
<head>
    ...
    <script src="js/adminAudit.js"></script>
    ...
    <!-- haeder end -->
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>以下新注册的用户未通过审核,请查询核对准确之后设置通过</b>&nbsp;&nbsp;&nbsp;&nbsp;</h4>
                        <br><br><br>
                    ...
                    <div class="panel">
                        <div class="panel-content">
                            <div class="table-responsive">
                                <button class="btn btn-success btn-wide" id="passselect">通过选中项</button>
                                <button class="btn btn-primary btn-wide" id="clearselect">清除选中项</button>
