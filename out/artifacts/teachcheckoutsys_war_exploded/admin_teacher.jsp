...
<head>
    ...
    <script src="js/amindTeacher.js"></script>
    ...
    <!-- haeder end -->
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>您可以通过导入Excel文件导入教师</b>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="https://teach-checkout.oss-cn-beijing.aliyuncs.com/teacher/teachsys/upload/教师表模板.xls">
                            点击下载“教师表模板.Excel”模板</a></h4>
                    <button class="btn btn-primary btn-wide" id="addstufile">导入教师</button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-primary btn-wide" id="addstu">添加成员</button>
